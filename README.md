...
### 실행화면
![INTRO](./Image/INTRO.png){: .center}
![WAIT](./Image/Wait.png){: .center}
![GOALSETTING](./Image/GOALSETTING.png){: .center}
![GAME](./Image/GAME.png){: .center}
![GAMEHINT](./Image/GAMEHINT.png){: .center}
### 게임진행
